...
def sign_with_jwt(data, private_key=None, algorithm=None):
    try:
        ...
        logger.warning("Failed to sign data:\n", e)
    return data
...
def post_progress(context, from_task=False):
    try:
        ...
        logger.warning("Failed to POST progress updates:\n", e)
...
def post_results(context):
    try:
        ...
        logger.warning("Failed to POST results:\n", e)
...
def post_status(context):
    try:
        ...
        logger.warning("Failed to POST status updates:\n", e)
